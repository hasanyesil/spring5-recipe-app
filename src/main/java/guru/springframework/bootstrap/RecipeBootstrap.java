...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //get UOMs
        Optional<UnitOfMeasure> eacUomOptional = unitOfMeasureRepository.findByDescription("Each");

        if (!eacUomOptional.isPresent()){
        ...
        //get optionals
        UnitOfMeasure eachUom = eacUomOptional.get();
